...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlxDash", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FlxDash", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "35";
		app.meta["company"] = "Trecus";
		app.meta["file"] = "FlxDash";
		app.meta["name"] = "FlxDash";
